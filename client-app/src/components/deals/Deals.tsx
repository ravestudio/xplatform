...
type DealsProps = DealsStore.DealsState &
              ...
              {this.props.deals.map((deal: DealsStore.Deal) => (
                <TableRow key={deal.id}>
                  ...
                  <TableCell align="right">
                    {this.getAccount(deal.accountId)}
                  </TableCell>
                  <TableCell align="right">
                    {this.getSecurity(deal.securityId) || "loading..."}
                  </TableCell>
                  <TableCell align="right">
                    {this.getOperation(deal.operation)}
                  </TableCell>
                  <TableCell align="right">
                    {format(parseISO(deal.date), "dd/MM/yyyy")}
                  </TableCell>
