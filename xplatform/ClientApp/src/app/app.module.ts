...
import { MdcButtonModule, MdcIconModule, MdcFormFieldModule, MdcTextFieldModule, MDCDataTableModule, MdcCheckboxModule, MdcListModule, MdcMenuModule, MdcSelectModule, MdcTabBarModule, MdcTopAppBarModule } from "./mdc";
