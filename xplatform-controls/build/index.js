...
var renderTextField = function (props) {
    ...
    return (React__default['default'].createElement(core.TextField, __assign({ label: label, placeholder: label, error: touched && invalid, helperText: touched && error }, input, custom)));
};
...
var TestComponent = function (_a) {
    ...
    return (React__default['default'].createElement("div", { "data-testid": "test-component", className: "test-component test-component-" + theme },
        ...
        React__default['default'].createElement(core.TextField, { label: "Hello", defaultValue: "Stas" })));
};
